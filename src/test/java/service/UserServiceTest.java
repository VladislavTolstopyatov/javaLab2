...
public class UserServiceTest {
    ...
    @Test
    void findUserByNickNameWhenUserExists() throws EntityNotFoundException {
        final User user = getUser();
    ...
    void findUserByEmailWhenUserNotExists() {
        ...
        assertThrows(EntityNotFoundException.class, () -> userService.findUserByEmail(userDto.getEmail()));
    }

    @Test
    void findUserByEmailWhenUserExists() throws EntityNotFoundException {
        final User user = getUser();
        final UserDto userDto = getUserDto();
    ...
    @Test
    void findUserByEmailAndPasswordWhenUserExists() throws EntityNotFoundException {
        final User user = getUser();
        final UserDto userDto = getUserDto();
    ...
    void findUserByEmailAndPasswordWhenUserNotExists() {
        ...
        assertThrows(EntityNotFoundException.class, () -> userService.findUserByPasswordAndEmail(password, userDto.getEmail()));
    }
    ...
    void findUserByNickNameWhenUserNotExists() {
        ...
        assertThrows(EntityNotFoundException.class, () -> userService.findUserByNickName(userDto.getNickName()));
    }
    ...
    @Test
    void findUserByIdWhenUserExists() throws EntityNotFoundException {
        final Long id = getUserDto().getId();
        final User user = getUser();
        final UserDto userDto = getUserDto();
